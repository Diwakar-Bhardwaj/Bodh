...
export default function QuizPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans antialiased pb-24 select-none">
      ...
      <div className="max-w-md mx-auto pt-6 px-4 flex items-center justify-between">
        ...
        <h1 className="text-lg font-bold tracking-wide">QNA</h1>
        <button
          type="button"
      ...
      <div className="max-w-md mx-auto px-4 mt-4 space-y-4">
        ...
        <div className="bg-[#5F4A78] rounded-[24px] p-4 shadow-md flex items-center gap-4">
          ...
          <div className="flex-1 space-y-1">
            <h3 className="text-sm font-black text-white tracking-wide">{currentQuestion?.book_title || "Book Title"}</h3>
        ...
        <div className="bg-[#D1D1D6] rounded-[32px] p-5 text-black space-y-4">
            ...
            {quizOptions.map((opt) => {
              ...
              return (
                <button
                  ...
                  className={`w-full p-3.5 rounded-[20px] flex items-center justify-between text-left transition-all font-bold text-xs ${buttonStyle}`}
                >
        ...
        <div className="pt-2">
          <button
            ...
            className={`w-full font-bold text-sm py-4 rounded-full flex items-center justify-center gap-2 shadow-md transition-all tracking-wide ${
              selectedOption 
